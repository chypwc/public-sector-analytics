...
The portfolio brings together projects across education, public health, workers compensation, hospital costing, labour-market analysis, and cloud data engineering. Across these projects, the work demonstrates the ability to:
...
| --- | --- |
| Public-sector reporting | Education monthly reporting, health surveillance dashboards, workers compensation financial/performance packs, ACT employment analysis |
